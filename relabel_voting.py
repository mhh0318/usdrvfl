...
def voting(clusters, layers):
    ...
    for row in clusters:
        ...
        for idx in range(len(u)):
            counter[idx] = row[:layers].count(u[idx])
...
if __name__ == '__main__':
    clusters = [[1,2,2,3,3,1], [2,3,3,1,1,2],[3,1,1,1,2,2]]

    relabeled_clusters = relabel_cluster(clusters)
    print(relabeled_clusters)
    print ("Output:")
    print (voting(relabeled_clusters,3))